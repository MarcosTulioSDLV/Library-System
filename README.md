...
I developed a Web Application to manage books and their authors in a library. This system allows to store book information such name, ISBN (only ISBN-13 format accepted), edition, and year. On the author side, it allows the storage of name, last name and email.
